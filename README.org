...
(with-eval-after-load 'starhugger
  ...
  (keymap-set starhugger-at-suggestion-map "TAB" #'starhugger-accept-suggestion)
  (keymap-set starhugger-at-suggestion-map "M-[" #'starhugger-show-prev-suggestion)
  (keymap-set starhugger-at-suggestion-map "M-]" #'starhugger-show-next-suggestion)
  
  (keymap-set starhugger-at-suggestion-map "M-f" #'starhugger-accept-suggestion-by-word)
  ...
  (defun my-starhugger-active-suggestion-mode-h ()
    (add-hook 'my-evil-force-normal-state-hook #'starhugger-dismiss-suggestion nil t))

  (add-hook 'starhugger-active-suggestion-mode-hook #'my-starhugger-active-suggestion-mode-h))
