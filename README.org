...
Currently supported model(s): [[https://huggingface.co/bigcode/starcoder][bigcode/starcoder]],
[[https://huggingface.co/codellama/CodeLlama-13b-hf][codellama/CodeLlama-13b-hf]].
...
Remember to set ~starhugger-hugging-face-api-token~ (from [[https://huggingface.co/settings/tokens]]), otherwise you may easily get hit by the limit rate.
